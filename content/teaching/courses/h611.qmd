...
To address this gap, I decided to organize our class meetings around peer instruction [@Mazur1997] such that students get the opportunity to practice applying their knowledge through repeated *verbal* explanation, in class. The aim of this solution is to remove the stress that comes from quiz/writeup "grading" (see my Teaching Philosophy for more on this), and give students a safe place to learn with others.

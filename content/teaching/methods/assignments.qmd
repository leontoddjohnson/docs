...
In my statistics class, I've incorporated peer instruction [@Mazur1997] into the class meeting using the [TopHat](https://tophat.com/) Canvas integration. After putting together several True/False questions, I would:
...
Each week, students in my mathematics course are assigned 8 True/False questions (on Canvas) in reference to a [notebook](https://colab.research.google.com/drive/1D8YYES5Evd37m9DSz3Nsonmg0w7YmEEn?usp=sharing). These questions are meant to apply what they learn from the (theoretical) lecture videos and slides seen before class meetings.

::: {.callout-tip collapse="true"}
## example question
An example question could be *Refer to Situation 1. This matrix also represents an invertible linear transformation. That is, it does NOT "squash" a 4-dimensional vector into a 3-dimensional space.*
:::
